...
def plot_the_time_series() -> None:
    ...
    np.fft.ifft(fft_filtered)


def plot_the_original_noisy_and_filtered_signals() -> None:
...
def main() -> None:
    plot_the_time_series()
    plot_the_original_noisy_and_filtered_signals()
